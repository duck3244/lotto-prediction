...
mpl.use("Agg")  # 헤드리스/ASGI 환경에서 GUI 백엔드 회피
...
def visualize_data(
    df: pd.DataFrame, frequencies: dict[int, int], output_dir: str | Path = "visualization",
) -> list[Path]:
    """
